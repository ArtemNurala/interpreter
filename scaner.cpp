...
TScaner::TScaner() : uk (0), ukLine (1), ukInLine (1)
{
	...
	KW["short"] = SHORT;
	KW["float"] = FLOAT;
	ErrorMessages[ERROR_OPEN_COMMENT_IN_THE_END] = "Открытый комментарий в конце кода";
	ErrorMessages[ERROR_UNKNOWN_LEKSEMA] = "Неизвестная лексема";
	ErrorMessages[ERROR_OPEN_CHAR_CONST] = "Незакрытая символьная лексема";
	ErrorMessages[ERROR_WRONG_CHAR_CONST] = "Неверная символьная лексема";
	ErrorMessages[ERROR_LEXEMA_IS_TOO_LONG] = "Слишком длинная лексема";
};
